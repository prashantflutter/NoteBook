...
class _NotebookPageState extends State<NotebookPage> {
  ...
  Future<void> addData() async {
    await SQLiteDatabase.createData(titleController.text.toString(),
        descController.text.toString(), image!.path);
    _refreshData();
  }
                              ...
                              ScaffoldMessenger.of(context)
                                ...
                                content: Row(
                                  children: const [
                                    ...
                                    Expanded(
                                        child: Text(
                                      'Please Create NoteBook to add Book Logo ,Title and Write content of Book!',
                                      maxLines: 2,
                                    )),
                                  ],
                                ),
